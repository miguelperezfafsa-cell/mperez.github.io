...
const CONFIG = {
  github: {
    username: 'miguelperezfafsa-cell', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  seo: {
    title: 'Portfolio of Miguel Perez',
    description: '',
    imageURL: '',
  },
  social: {
    linkedin: 'miguelperezfafsa-cell',
    x: '',
    mastodon: '',
    researchGate: '',
    facebook: '',
    ...
    skype: '',
    telegram: '',
    website: 'https://miguelperezfafsa-cell.github.io',
    phone: '2093609417',
    email: 'mperez104@csustan.edu',
  },
  resume: {
    fileUrl:
  ...
  experiences: [
    {
      company: 'CSU Stanislaus Department of Biological Sciences',
      position: 'Intern of Microbiology',
      from: 'February 2026',
      to: 'Present',
